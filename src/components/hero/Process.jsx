...
export const Process = () => {
  return (
    <>
      <section className="process py-24 bg-[#091c2e] relative">
        ...
        <Container className="py-16 pt-24 text-white">
          ...
          <div className="content grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
            {processList.map((item, index) => (
              <div key={index} className="p-8 bg-[#fc7070] rounded-xl flex items-center justify-center flex-col text-center">
